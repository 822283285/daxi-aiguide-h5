...
(function () {
  ...
  define("cordova/exec", function (require, exports, module) {
    ...
    function pollOnce(opt_fromOnlineEvent) {
      ...
      // console.log("NativeToJsMessageQueue:retrieveJsMessages  Native begin============>>>>");
      var msgs = nativeApiProvider.get().retrieveJsMessages(bridgeSecret, !!opt_fromOnlineEvent);
      // // console.log("NativeToJsMessageQueue:retrieveJsMessages  Native end<<<<=============");
      // console.log("NativeToJsMessageQueue: retrieveJsMessages---bridgeSecret:[" + bridgeSecret + "] msg:[" + msgs + "]");
      if (msgs) {
        messagesFromNative.push(msgs);
