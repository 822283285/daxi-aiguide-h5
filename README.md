...
- **Smoke 检查**：校验以下 HTML 中本地 `<script src="...">` 引用文件是否存在；
...
[PASS] [syntax] map-ui-container/assets/js/bootstrap.js
[PASS] [smoke] map-ui-container/assets/js/bootstrap.js referenced by map-ui-container/index.html
