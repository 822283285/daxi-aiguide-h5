(function(global){
    ...
    function create3dMan(){
        ...
        loader.load('./assets/model/yunbao_02.fbx', (fbx) => {
	...
	function changeColor(){
		if(dhjt){
		  let color =  dhjt.children[1].material;			   
		 dhjt.children[1].material = dhjt.children[2]. material;
		 dhjt.children[2].material = color;
