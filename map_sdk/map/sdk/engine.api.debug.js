(function(global) {
    ...
    var api_utils = {
        ...
        createCanvas: function(containerId, canvasId, options) {
            ...
            _containerStyle.background = _containerStyle.background || "#fff";//"#c6efad";
    ...
    WebMap3D.init = function(mapId, options, successCallback, failusCallback,canvasDom) {
        ...
        var resourceList = [
            baseMapPath + "../map_js_src/ThirdParty/requirejs-2.1.6/require.js",
            baseMapPath + "css/map.css",
            baseMapPath + "css/control.css"
        ];
        api_utils.loadResources(resourceList, function(){
            window["requireJsFunc"]  = requirejs;
            requirejs.config({
                "baseUrl" : baseMapPath + "../map_js_src/Source/",
                "paths" : {
                    "domReady": '../ThirdParty/requirejs-2.1.6/domReady'
                }
            });
            window["requireJsFunc"]([baseMapPath + "../map_js_src/Source/IndexMain.js"], function(engineApi){
                var sdk = createUserSDK(engineApi, mapId, options,canvasDom);
                successCallback && successCallback(sdk);
            })
        });
        // var resourceList = [
        //     baseMapPath + "map/sdk/map.min.js",
        //     baseMapPath + "/css/map.css"
        // ];
        // api_utils.loadResources(resourceList, function(){
        //     window.onload = function(){
        //         var engineApi = window["App"];
        //         var sdk = createUserSDK(engineApi, mapId, options);
        //         successCallback && successCallback(sdk);
