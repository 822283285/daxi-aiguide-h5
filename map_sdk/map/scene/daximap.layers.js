 ...
 * @param {String} params.layerId 图层 ID
 * @param {String} params.layerType 图层类型
 * @param {String} params.sourceId 数据源 ID
...
if (typeof window !== "undefined") {
  ...
  window.DaxiMap.DXLayerConstants = DXLayerConstants;
  window.DaxiMap.DXLayerUtils = DXLayerUtils;
}
